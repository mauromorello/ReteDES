<?php
if (eregi("articoli_main.php", $_SERVER['SCRIPT_NAME'])) {
...
// HEADER HTML
	  ...
	  if (!empty($is_ckeditor)){
		$h .= java_head_ckeditor();
	  }
	  
	  $h .= java_head_jquery_superfish();
	  
	  if (!empty($datepickers)){        
		$h .= java_head_jquery_datepicker();
	  }
	  ...
	  if (!empty($datepickers)){        
		$h .= java_datepicker($datepickers_name_1);
	  }
