...
if (!_USER_LOGGED_IN){
	...
	$retegas->posizione = "Panoramica Annuale DES";
	...
	$retegas->java_headers = array("rg");  // menu a scomparsa verticale
	  ...
	  $retegas->java_scripts_header[]=c1_javascript_timeline(_USER_ID,"des"); // TIMELINE
	  ...
	  $h="<div class=\"rg_widget rg_widget_helper\">
        ...
        $h .='<div id="my-timeline" style="height:600; border: 1px solid #aaa"></div>
        </div>';
