...
$my_query="SELECT
            ...
            format(Sum(retegas_dettaglio_ordini.prz_dett_arr*retegas_dettaglio_ordini.qta_ord),2) AS tot,
...
if(_USER_OPT_NO_HEADER=="SI"){
    $i="";
    $o= "<h2>Ordine $id_ordine (".descrizione_ordine_from_id_ordine($id_ordine).") Solo scatole intere</h2>";

}else{
    $i=load_pdf_header("../../images/rg.jpg");
    $o=render_scheda_pdf_ordine($id_ordine).
    "<h2>Solo scatole intere</h2>";;    
}
