...
if (is_logged_in($user)){
        ...
        if(!posso_gestire_ordine_full($id,$id_user)){
                go("ordini_form",_USER_ID,"Questa operazione ti è preclusa.","?id_ordine=$id");
                exit;
        }else{
...
$h_table .=  "
    ...
    $retegas->posizione = "Comunicazioni";
          ...
          // Dico a retegas come sarà composta la pagina, cio? da che sezioni ? composta.
    // Queste sono contenute in un array che ho chiamato HTML standard
    
    $retegas->sezioni = $retegas->html_standard;
      
    // Il menu' orizzontale ? pronto ma ? vuoto. Con questa istruzione lo riempio con un elemento
    $retegas->menu_sito = ordini_menu_all($id); 
