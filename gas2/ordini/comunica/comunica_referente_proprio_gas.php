...
if($do=="send_mail"){           // REFERENTE ORDIND-----> REFERENTI GAS
       ...
       $da_chi = fullname_from_id(_USER_ID);
          ...
          $verso_chi = fullname_referente_ordine_proprio_gas($id_ordine,_USER_ID_GAS); 
          $mail_verso_chi = mail_referente_ordine_proprio_gas($id_ordine,_USER_ID_GAS);
...
//Contenuto
    $titolo__form_mail="Manda un messaggio al referente del tuo GAS per questo ordine";
            $lista_destinatari = fullname_referente_ordine_proprio_gas($id_ordine,_USER_ID_GAS);
            $posizione_estesa ="Referente proprio GAS";
