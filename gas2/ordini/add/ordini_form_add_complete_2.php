...
if($do=="add"){
        ...
        if(empty($data_consegna) | $data_consegna==""){
            $data_consegna=$data_chiusura;
        }
       ...
       // }
        ...
        if($e_total==0){
            ...
            $data_merce = conv_date_to_db($data_consegna);
...
$r->javascripts[] = c1_ext_javascript_datetimepicker("#dataconsegna");
...
//Contenuto
        ...
        $help_data_consegna ='Una data (indicativa) di consegna';
        ...
        <div>
        <h4>5</h4>
        <label for="dataconsegna">...una previsione di consegna merce</label>
        <input id="dataconsegna" type="text" name="data_consegna" value="'.$data_consegna.'" size="20"></input>
        <h5 title="'.$help_data_consegna.'">Inf.</h5>
        </div>
