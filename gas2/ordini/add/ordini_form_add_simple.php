...
if (is_logged_in($user)){
	...
	if($do=="add"){
			...
			$msg = 	ordine_render_do_add_simple($id);
			if($msg=="OK"){$msg="Ordine programmato correttamente<br>Sarà attivo tra 2 ore, così se vuoi cambiare qualcosa o cancellarllo,<br>ne hai la possibilità";
