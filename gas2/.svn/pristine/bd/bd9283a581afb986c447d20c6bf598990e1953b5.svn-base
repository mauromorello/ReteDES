<?php
  if (eregi("oa_art_ord_crono_table.php", $_SERVER['SCRIPT_NAME'])) {
	 Header("Location: ../../index.php"); die();
}
// --------------START articoli

	  
	  $titolo_tabella="Cronologia articolo $id_art, ordine $id <div class=\"ui-state-error ui-corner-all padding_6px\" style=\"text-align:center;\">Finchè l'ordine non sarà chiuso, questa tabella è da considerarsi PROVVISORIA</div>";
	  ...
	  $my_query="SELECT
					...
					retegas_dettaglio_ordini.timestamp_ord as pippo,
