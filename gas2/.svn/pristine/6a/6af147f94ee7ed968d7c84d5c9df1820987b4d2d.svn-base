...
if($valore_mio_gas>0){
    $percent_gas = ($subt_gas / valore_totale_mio_gas($id,$id_g)) * 100;
...
//COSTI PUBBLICI
  ...
  $h_table.= "
                <tr class=\"subtotal\" style=\"margin-bottom:10px; border-bottom: 1px solid #000\">
                    <td $col_1>$nbsp</td> 
                    <td $col_2>Subtotale Pubblico</td>    
                    <td $col_3>$nbsp</td>
                    <td $col_4>$nbsp</td>
                    <td $col_5>$nbsp</td>
                    <td $col_6>$nbsp</td>
                    <td $col_7>$cpu $euro</td>
                    <td $col_8>$somma_pubblica_gas $euro</td>  
                </tr>
            ";
...
if($costo_gas>0){
    ...
    if(is_integer($riga/2)){  
      ...
      $h_table.= "
                ...
                <tr class=\"costo1\" style=\"border-bottom: 1px solid #000\">
                    <td $col_1>$nbsp</td> 
                    <td $col_2>Costo GAS</td>    
                    <td $col_3>$nbsp</td>
                    <td $col_4>$nbsp</td>
                    <td $col_5>$nbsp</td>
                    <td $col_6>$nbsp</td>
                    <td $col_7>$costo_gas $euro</td>
                    <td $col_8>$nbsp</td>
...
if($percent_maggiorazione_gas>0){
  ...
  $h_table.= "
                <tr class=\"subtotal\" style=\"margin-bottom:10px; border-bottom: 1px solid #000\">
                    <td $col_1>$nbsp</td> 
                   <td $col_2>Subtotale Privato</td>    
                    <td $col_3>$nbsp</td>
                    <td $col_4>$nbsp</td>
                    <td $col_5>$nbsp</td>
                    <td $col_6>$nbsp</td>
                    <td $col_7>$cpr $euro</td>
                    <td $col_8>$nbsp</td>  
                </tr>
            ";
  }
  
  $c_tot = number_format((float)round($costo_gas + $magg_gas + $trasporto_percentuale + $gestione_percentuale,2),2,",","");
  $tot_tot = number_format((float)round($costo_gas + $magg_gas + $trasporto_percentuale + $gestione_percentuale+ $subt_gas,2),2,",","");
  $h_table.= "
                <tr class=\"total\" style=\"margin-bottom:10px; border-bottom: 1px solid #000\">
                    <td $col_1>$nbsp</td> 
                    <td $col_2>TOTALE GAS ($subt_nome_gas) :</td>    
                    <td $col_3>$nbsp</td>
                    <td $col_4>$nbsp</td>
                    <td $col_5>$nbsp</td> 
                    <td $col_6>$sa $euro</td> 
                    <td $col_7>$c_tot $euro</td> 
                    <td $col_8>$tot_tot $euro</td> 
