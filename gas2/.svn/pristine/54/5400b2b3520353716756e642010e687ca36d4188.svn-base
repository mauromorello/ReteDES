...
if (is_logged_in($user)){
	 ...
	 // --- menu aperto
	  ...
	  // c2 = id listino
	  //$table_sorter_name = "oa_art_dett";
	  $table_group_name = "oa_art_dett";
	  
	  include ("oa_art_dett.php"); 
	  // HEADER HTML
	  //$msg ="Pagina non ancora funzionante";
	  $posizione ="ORDINI APERTI -> Gestione ordine -> <b> Dettaglio Articoli ordinati</b>";
