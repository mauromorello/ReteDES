...
if (is_logged_in($user)){
	  ...
	  $msg = "Messaggio cron $id cancellato";
	  ...
	  $query="select * from retegas_messaggi WHERE retegas_messaggi.tipo='CRO' order by id_messaggio DESC LIMIT 200";
	  ...
	  { 
	  $h_table .= '<tr><td><a href="amministra_messaggi_cron.php?do=del&id='.$row[0].'">Canc</a>
