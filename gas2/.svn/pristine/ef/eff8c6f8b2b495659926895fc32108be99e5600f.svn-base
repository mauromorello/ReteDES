<?php
  if (eregi("oc_mia_spesa_av_amm_formatting_screen.php", $_SERVER['SCRIPT_NAME'])) {
  ...
  //  LARGHEZZA E CLASSI COLONNE
	  $col_1="width=\"4%\"";    //opzioni    
	  $col_2="width=\"10%\" class=\"gas_c1\"";
	  $col_3="width=\"*\" class=\"gas_c1\"  style=\"text-align:left;\"";
