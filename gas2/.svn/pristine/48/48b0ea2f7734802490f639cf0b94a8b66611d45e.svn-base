...
$qu = "SELECT
        ...
        Inner Join retegas_articoli ON retegas_distribuzione_spesa.id_articoli = retegas_articoli.id_articoli
...
$res = $db->sql_query($qu);
        while ($row = mysql_fetch_array($res)){
            ...
            $tot_riga = _nf($row["qta_arr"]*$row["prezzo"]);
            ...
            $h .="<td class=\"sinistra\">".$row["codice"].$extra_code."</td>";
