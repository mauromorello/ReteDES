...
if($do=="send"){
	...
	$retegas->posizione = "Comunicazione (mod. HERMES) al mio GAS";
	...
	$retegas->java_headers = array("rg",   // menu a scomparsa orizzontale
	  ...
	  $retegas->content =  '<div class="ui-state-error padding_6px ui-corner-all" style="font-size:1.2em; margin:1em;"><b>ATTENZIONE :</b> in modalit? "<a href="http://it.wikipedia.org/wiki/Ermes">HERMES</a>" i messaggi arriveranno a tutti gli utenti del tuo gas iscritti al sito, scavalcando le loro impostazioni sulla privacy.<br>Questa modalit?
	  ? accessibile solo se tu sei il referente ReteGas.AP del tuo Gas, oppure fai parte del PROGETTO DES.</div>';
