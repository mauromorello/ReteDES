...
return $h_table;
  ...
  function gas_render_user_activity($id_gas,$table_ref){
	...
	$h .= " <div class=\"rg_widget rg_widget_helper\">
			...
			<h3>Attività utenti $gas_name</h3>
	...
	$col_1 = " WIDTH=30% ";
	 ...
	 $h_table .=  "
					...
					<tr class=\"odd\">
						...
						<th $col_1>Sede (l'indirizzo se è valido verrà usato per le mappe)</th>
					...
					<tr class=\"odd\">
						...
						<th $col_1>Motivazione della percentuale di maggiorazione che verrà applicata ad ogni nuovo ordine aperto. (Rifierita solamente al vostro GAS)</th>
					...
					<tr class=\"odd\">
						...
						<th $col_1>Maggiorazione percentuale che verrà applicata solo ai vostri ordini.</th>
  ...
  function gas_render_new_user_form($user){
	  ...
	  $h='<div class="rg_widget rg_widget_helper">
		  ...
		  Se il nuovo utente non accede al sito entro 48 ore il suo account verrà eliminato automaticamente<br>

		  Verrà inviata contestualmente all\'iscrizione una mail per avvisarlo, che risulterà proveniente dall\'user che lo ha iscritto.<br>

		  <b>Chi inserisce un nuovo utente si assume la responsabilità di accettare regole e disclaimer

		  per conto terzi</b><br>

		  Ogni operazione in questo senso è loggata e sarà visibile dall\'amministratore del sito e da chi esso

		  autorizzerà a farlo.<br>
