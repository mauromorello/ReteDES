...
if(_USER_LOGGED_IN){
    ...
    $c="
            ...
            <h4>ReteDES.it (Rete dei Distretti Economia Solidale) è un social-coso informatico a \"Km 0\" nato per
            ...
            <div data-role=\"collapsible\">
               ...
               <p>Il progetto \"ReteDes.it - Rete dei DES\" nasce dall'esigenza degli utenti di alcuni Gas di voler gestire in maniera semplice e pratica gli ordini di acquisto.<br>
                        E' stato realizzato all'interno del GAS di Borgomanero nella forma di software gestionale in grado di gestire gli acquisti all'interno del proprio gruppo, in collaborazione con alcuni GAS \"confinanti\" o addirittura con tutti i GAS aderenti al progetto. Dopo una prima fase positiva di collaudo, il sistema è stato poi presentato a diversi GAS dell'Alto Piemonte che lo hanno adottato come valido strumento per la promozione di una soddisfacente e dinamica rete di collaborazione reciproca.
                        Questo progetto è stato concepito ponendo come filosofia fondante la necessità di agevolare ed incentivare l'iniziativa personale di ciascun singolo aderente ad un GAS di porsi come promotore e responsabile di un determinato acquisto. Questo si realizza grazie alla flessibilità della piattaforma, che permette ad ognuno di creare ordini costruendoli secondo le proprie capacità e disponibilità di tempo da impiegare in tale iniziativa. Tra le diverse opportunità, è da sottolineare ad esempio, la possibilità in sede di creazione dell'ordine, di stabilire quanti e quali GAS aderenti saranno coinvolti nell'ordine stesso.
                        L' organizzazione di ogni ordine è di tipo gerarchico e si sviluppa a diversi livelli: Responsabile dell' ordine: è il promotore dell'intero ordine ed anche responsabile per il proprio GAS di appartenenza; Responsabile GAS: è il responsabile di ciascun GAS coinvolto. Il suo compito è quello di mantenere il collegamento tra il suo GAS di appartenenza con il Responsabile dell'ordine. Utente finale: chiunque sia iscritto a Retegasap potrà gestire personalmente i propri acquisti; potrà chiedere e ricevere informazioni in merito ai responsabili a vari livelli.
                        Il sito è in continua evoluzione e miglioramento, soprattutto per adattarlo alle richieste che ogni utente ed ogni GAS può sentirsi libero di esprimere. Tutto ciò è basato sull'impegno e sul lavoro volontario di alcuni partecipanti ai vari GAS.</p>
            </div>
...
//Creo la pagina solo se l'utente non è loggato
if(!_USER_LOGGED_IN){
    $j->jqm_pages[]=$p->jqm_render_page();
}
