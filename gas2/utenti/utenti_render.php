...
function utenti_render_register_form(){
        ...
        $help_email ='Inserisci una email valida. Al termine della registrazione ti arriverà una mail di conferma.';
        $help_tel ='Inserisci un tuo valido recapito telefonico.';
        $help_consenso='Leggi attentamente, anche se a prima vista può risultare noioso. In questo disclaimer vi è anche la parte sul trattamento dei dati personali.';
...
<table>
    ...
    <tr class="odd">
        <th >Avvisami 3 giorni prima che si chiuda un ordine al quale io posso partecipare o sto già partecipando
        <br>
        <cite>
    ...
    <tr class="odd">
        ...
        <cite>(Attenzione : se si toglie questa opzione, si verrà esclusi dalla mailing-list del sito.)
        </cite>
        </th>
