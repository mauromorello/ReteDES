...
if (is_logged_in($user)){
    ...
    if($do=="filter"){
     ...
     //FIXUP per jquery datepicker
    $retegas->css_body[] = "
                            <style> #ui-datepicker-div { display: none; }</style>
                            ";
 
 $serie_dati = storici_famiglie_gas_grafico($filter,$arg1,$arg2);
      // GRAFICO 2
      ...
      <script type=\"text/javascript\">
               ...
               chart2 = new Highcharts.Chart({
                ...
                title : {
                            text: 'Distribuzione spesa famiglie',
                            style: 'font-size:.7em;',
                            align: 'left'
                     },
                xAxis: {
      ...
      '<div style="position:relative; width: 100%; display:table;">
                <div id="container2" style="width: 100%; height: 46em;   display:table-cell"></div>
       </div>';
		
          // qui ci va la pagina vera e proria  
	  $retegas->content  =  "<div class=\"rg_widget rg_widget_helper\"><h3>Storico Famiglie</h3>".$h."</div>";
