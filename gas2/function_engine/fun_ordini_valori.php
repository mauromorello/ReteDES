...
$sql="SELECT
Sum(retegas_dettaglio_ordini.qta_ord*retegas_dettaglio_ordini.prz_dett_arr) AS somma_valore_ordine
FROM
retegas_ordini
...
global $db;
$qry = "SELECT
Sum(retegas_dettaglio_ordini.qta_arr*retegas_dettaglio_ordini.prz_dett_arr)
FROM
...
// la nuova query si appoggia sul prezzo arrivato nella tabella dettaglio articoli
$sql ="SELECT Sum(retegas_dettaglio_ordini.prz_dett_arr * retegas_distribuzione_spesa.qta_arr) as tot_amico
FROM
...
$sql="SELECT
Sum(retegas_dettaglio_ordini.qta_arr*retegas_dettaglio_ordini.prz_dett_arr) AS somma_valore_ordine
FROM
retegas_ordini
Inner Join retegas_dettaglio_ordini ON retegas_ordini.id_ordini = retegas_dettaglio_ordini.id_ordine
left Join retegas_articoli ON retegas_dettaglio_ordini.id_articoli = retegas_articoli.id_articoli
