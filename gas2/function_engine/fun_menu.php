...
//----------------------------------------------------GAS
  ...
  function gas_menu_visualizza(){
      ...
      global $RG_addr;
            ...
            $h_menu .='<li><a class="medium green awesome" href="'.$RG_addr["gas_ids"].'" target="_self">Indice di solidarietà</a></li>';
      ...
      if((_USER_PERMISSIONS & perm::puo_postare_messaggi)){ 
            ...
            $h_menu .='<ul>';
                    ...
                    if(id_proprio_referente_retegas(_USER_ID_GAS)==_USER_ID){
                        ...
                        $h_menu .='<li><a class="medium black awesome" href="gas_comunica_retegas_hermes.php" target="_self">a tutta '._SITE_NAME.' (modalità HERMES)</a></li>';
                    }
...
//-------------------------------------------------ORDINI
    ...
    $rettifica_users_new ='<a class="awesome medium blue"  href="'.$RG_addr["rettifica_quantita_art_user"].'?id_ordine='.$id_ordine.'" >Quantità articoli singoli utenti</a>';
    ...
    $rettifica_quantita_csv ='<a class="awesome medium blue"  href="'.$RG_addr["rettifica_quantita_csv"].'?id_ordine='.$id_ordine.'" >Rettifica quantità OFFLINE</a>';
    ...
    global $RG_addr;
        ...
        //SE l'ordine è solo per chi usa la cassa
        if(_GAS_USA_CASSA){
