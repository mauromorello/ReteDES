...
$locations_ordini=Array(  "ordini_aperti"           =>$root."ordini/aperti/ordini_table_aperti.php",
                          ...
                          "edit_distribuzione_gas"  =>$root."ordini/edit/ordini_form_edit_gas_distribuzione.php",
                          ...
                          "ordini_deny_print"        =>$root."ordini/edit/ordini_deny_print.php",
                          ...
                          //ALTRO
                          "di_chi_e_questo"         =>$root."ordini/gestore/di_chi_e_questo.php",
                          "ordine_log_pubblico"     =>$root."ordini/gestore/ordine_log_pubblico.php",
                          "ordini_aggiungi_referenti"     =>$root."ordini/gestore/ordini_aggiungi_referenti.php",

                          //COMUNICA
                          "comunica_referente_ordine"     =>$root."ordini/comunica/comunica_referente_ordine.php",
                          "comunica_referenti_gas"     =>$root."ordini/comunica/comunica_referenti_gas.php",
                          "comunica_referente_proprio_gas"     =>$root."ordini/comunica/comunica_referente_proprio_gas.php",
                          "comunica_partecipanti_mio_gas"     =>$root."ordini/comunica/comunica_partecipanti_mio_gas.php",
                          "comunica_alcuni_partecipanti"     =>$root."ordini/comunica/comunica_alcuni_partecipanti.php",

                          //RETTIFICHE
                          "rettifica_totali"                    =>$root."ordini/rettifiche/rettifica_quantita_totali.php",
                          "rettifica_singoli_valori"            =>$root."ordini/rettifiche/rettifica_singoli_valori.php",
                          ...
                          "rettifica_denaro_user_riga"          =>$root."ordini/rettifiche/rettifica_denaro_user_riga.php",
                          "rettifica_excellike"                 =>$root."ordini/rettifiche/rettifica_excellike.php",
