...
<tr>
    <td width=\"50%\" align=\"left\">
        <a href=\"\">
        <img align=\"left\" src=\"$img_path\" border=\"0\" width=\"75\" height=\"75\" alt=\"ReteDES.it\">
        </a>
    </td>
...
function main_render_anomalie_utente($id_user){
    ...
    if($ordini_non_confermati==1){
        $frase = "C'è un ordine chiuso da più di 20 giorni ma non CONVALIDATO";
    }else{
    ...
    if($permissions & perm::puo_vedere_retegas){
        if(utenti_attesa_attivazione(0)>0){

                    $h .='<div class="ui-state-highlight ui-corner-all padding_6px"><strong>Ci sono nuovi GAS da Creare ? </strong> Cliccando <a class="medium silver awesome" href="'.$RG_addr["des_nuovi_utenti"].'" style="margin-top:.5em"> QUI </a> si va nella pagina apposita.</div>';
                    $h .='<br>';
