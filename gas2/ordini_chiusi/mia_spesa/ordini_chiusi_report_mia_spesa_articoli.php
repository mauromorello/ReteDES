...
if (is_logged_in($user)){
	 ...
	 // --- menu aperto
	  ...
	  // menu
	  $pdf_url = "oc_mia_spesa_pdf.php?id=$id&is_pdf=pdf";
	  $display_url = "oc_mia_spesa_pdf.php?id=$id&is_pdf=screen";
	  ...
	  include ("oc_mia_spesa.php"); 
	  // HEADER HTML
	  //$msg ="Pagina non ancora funzionante";
	  $posizione = "ORDINI CHIUSI -> La mia spesa -> <b>Dettaglio assegnazioni</b>";
