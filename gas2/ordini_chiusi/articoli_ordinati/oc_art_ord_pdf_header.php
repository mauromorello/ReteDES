...
//include("../../phpqrcode/qrlib.php");
  ...
  if (eregi("oc_art_ord_pdf_header.php", $_SERVER['SCRIPT_NAME'])) {
...
//if(!file_exists ("../../../gas2/images/QR/ORD-$id-Articoli.png")){
//$errorCorrectionLevel = 'L';
//$matrixPointSize = 1; 
//QRcode::png($RG_addr["img_qrcode_oc_art_ord"].'?id='.$id, "../../../gas2/images/QR/ORD-$id-Articoli.png"); // creates file
//}


//if($is_pdf=="screen"){
//$QC_path = "../../../gas2/images/QR/ORD-$id-Articoli.png";  
//}else{
//$QC_path = "QR/ORD-$id-Articoli.png";       
//}
