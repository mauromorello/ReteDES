<?php
  if (eregi("oc_art_ord.php", $_SERVER['SCRIPT_NAME'])) {
...
// --------------START articoli
	  ...
	  $titolo_tabella="Raggruppamento articoli ORDINATI dagli utenti";
	  
	 
	  if(isset($is_pdf)){
		  include("oc_art_ord_formatting_pdf.php");
	  }else{
		  include("oc_art_ord_formatting_screen.php");
	  }
