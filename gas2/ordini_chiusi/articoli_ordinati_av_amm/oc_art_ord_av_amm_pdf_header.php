...
//include("../../phpqrcode/qrlib.php");
  ...
  if (eregi("oc_art_ord_av_amm_header.php", $_SERVER['SCRIPT_NAME'])) {
...
//if(!file_exists ("../../../gas2/images/QR/ORD-$id-Articoli_av_amm.png")){
//$errorCorrectionLevel = 'L';
//$matrixPointSize = 1; 
//QRcode::png($RG_addr["img_qrcode_av_amm"].'?id='.$id, "../../../gas2/images/QR/ORD-$id-Articoli_av_amm.png"); // creates file
//}


//if($is_pdf=="screen"){
//$QC_path = "../../../gas2/images/QR/ORD-$id-Articoli_av_amm.png";  
//}else{
//$QC_path = "QR/ORD-$id-Articoli_av_amm.png";       
//}
